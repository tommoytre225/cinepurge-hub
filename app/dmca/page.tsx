      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <div className="border-t border-[#374151] pt-8">
            ...
            <ol className="space-y-3 text-foreground-muted ml-4">
          ...
          <div className="border-t border-[#374151] pt-8">
            ...
            <div className="bg-black/50 backdrop-blur border border-primary/30 rounded-lg p-6 space-y-3">
              <p className="text-foreground-muted">
                <strong className="text-accent">Rappel :</strong> Ce hub ne contient pas de contenu soumis à droits d'auteur. Si votre problème concerne du contenu sur la plateforme CinePurge elle-même, vous devez contacter CinePurge directement.
              </p>
              <p className="text-foreground-muted">
