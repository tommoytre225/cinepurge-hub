        ...
        <div className="space-y-8">
          ...
          <div className="border-t border-[#374151] pt-8">
            ...
            <p className="text-foreground-muted">
              La seule exception : si vous fermez la notification d'installation PWA, ce choix est sauvegardé dans le <code className="bg-black/50 px-2 py-1 rounded text-accent">localStorage</code> de votre navigateur. Cette donnée reste <strong>uniquement sur votre appareil</strong> et n'est jamais envoyée à nos serveurs.
            </p>
          </div>
          ...
          <div className="border-t border-[#374151] pt-8">
            ...
            <ul className="space-y-2 text-foreground-muted ml-4">
          ...
          <div className="border-t border-[#374151] pt-8">
            ...
            <p className="text-foreground-muted mb-4">
              <strong>Important :</strong> Cette politique de confidentialité ne s'applique qu'à ce hub. Une fois que vous accédez à CinePurge lui-même, <strong className="text-accent">c'est sa propre politique de confidentialité qui s'applique</strong>.
            </p>
            <p className="text-foreground-muted">
